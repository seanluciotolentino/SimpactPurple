...
distance = [[1,3,4],[3,1,5],[4,5,1]]       # where they migrate
timing = [[1,3,4],[3,1,5],[4,5,1]]         # how long they migrate for
...
if rank == 0: #Migration Operator
    mo = MigrationOperator.MigrationOperator(comm, primaries, proportion_migrate, distance)
    ...
    print rank, "prevalence", GraphsAndData.prevalence(s)